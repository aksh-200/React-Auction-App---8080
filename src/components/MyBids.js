...
export default function MyBids() {
  ...
  <div className="card-body">
    <h4 className="card-title">{v.bt.p_Id.product_name}</h4>
    <h5 className="card-title">Category : {v.bt.p_Id.category_id.category_name}</h5>
    <h5 className="card-title"> Auction End Date: {v.bt.p_Id.end_date}</h5>
    <h5 className="card-title"> Your Bidding(Rs.): {v.bt.bid_price}</h5>
                ...
                <td>
                  ...
                  <div className="card shadow-sm p-3 mb-5 bg-white rounded ms-2 me-3"  width="30rem"  >
  <div className="card-body">
    <h4 className="card-title">Currently you are highest bidder for this product</h4> <br />
    <h5 className="card-title"> Highest Bidding(Rs.): {v.highest_bid_price}</h5>
