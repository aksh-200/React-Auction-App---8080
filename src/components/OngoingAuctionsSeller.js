...
export default function OngoingAuctionsSeller() {
  ...
  return (
    <div >
      ...
      <table className="table table-bordered "  style={{ backgroundColor: "white" }}>
        {products.map((v) => {
          return (
            <tr className="shadow p-3 mb-5 bg-white rounded me-5" > 
  ...
  <div className="card-body">
    ...
    <h5 className="card-title">Base Price: Rs. {v.p_Id.base_price}</h5>
              ...
              <div className="card shadow p-3 mb-5 bg-white rounded me-5 lineargradientbackground"  width="18rem"  height="270">
  <div className="card-body">
    <h5 className="card-title"> Current Highest Bid </h5>
    <h5 className="card-title"> {v.bidding_transaction_id == null ? (
                    "No Bids Placed Yet."
                  ) : (
                    <>
                  ...
                  <h4 className="card-title">  Next Bid Ammount(Rs.) :{" "}
                  {Math.round(
                    v.bidding_transaction_id == null
                      ? v.p_Id.base_price
                      : 1.02 * v.bidding_transaction_id.bid_price
